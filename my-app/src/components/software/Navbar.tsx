...
const Navbar = () => {
  ...
  return (
    <header className={`flex w-full items-center bg-white mx-auto     `}>
        ...
        <div className="relative -mx-4 flex items-center justify-between">
          ...
          <div className="flex w-full items-center justify-between px-4">
            ...
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              ...
              <a
                href="/#"
                className="rounded-md bg-primary px-7 py-3 text-base font-medium text-dark hover:bg-primary/90"
              >
                Download
              </a>
            </div>
