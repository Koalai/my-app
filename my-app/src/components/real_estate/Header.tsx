export const Header = () => {
  return (
    <div className="mt-[20px]">
      ...
      <div className=" flex bg-[#1A1A1A] rounded-[24px] p-[20px] mx-auto mt-[150px] w-[65%]">
        ...
        <div className="flex flex-col px-[30px] gap-1 mr-[60px] justify-center border-r-[1px] border-white border-opacity-10">
